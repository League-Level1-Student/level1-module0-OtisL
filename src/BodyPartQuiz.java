...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		String guess = JOptionPane.showInputDialog("who is this? (first name and no caps)");
		...
		if (guess.equals("arnold")) {
			...
			System.out.println("Your are wrong-it was arnold");
		}
		// 6. Otherwise:
		...
		guess = JOptionPane.showInputDialog("who is this? (first name and no caps)");
		...
		if (guess.equals("leonardo")) {
			...
			System.out.println("Your are wrong-it was leonardo");
		}
		// 6. Otherwise:
		// -- Tell them they are wrong and who the person is
		...
		if (guess.equals("jack")) {
			...
			System.out.println("Your are wrong-it was jack");
		}
		// 6. Otherwise:
		// -- Tell them they are wrong and who the person is
